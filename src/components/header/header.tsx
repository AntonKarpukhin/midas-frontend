		...
		<header className={styles.header}>
			...
			<ul className={styles.wrapperUl}>
				<NavLink className={styles.link}>
					АКЦИИ
					<img src="../../../public/Hot.svg" alt="Корзина"/>
				</NavLink>
				<div onClick={changeMenu} className={cn(styles.link, {
			...
			<div className={styles.wrapperLineMenu}>
			...
			<div className={styles.wrapperHelpers}>
				<label className={styles.label} htmlFor="search">
					<input id="search" className={styles.input} name='name' type='text'/>
					<img className={styles.search} src="../../../public/Search.svg" alt="Корзина"/>
				</label>
				<NavLink>
